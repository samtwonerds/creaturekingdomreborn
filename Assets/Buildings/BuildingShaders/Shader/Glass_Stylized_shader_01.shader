...
////// Emissive:
                ...
                float node_3723 = saturate(( _CrystalClearness > 0.5 ? (1.0-(1.0-2.0*(_CrystalClearness-0.5))*(1.0-saturate(round( 0.5*(node_4316 + _Surface_var.r))))) : (2.0*_CrystalClearness*saturate(round( 0.5*(node_4316 + _Surface_var.r)))) ));
                return fixed4(finalColor,node_3723);
            }
            ENDCG
        }
    }
