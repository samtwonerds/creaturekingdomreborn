...
////// Emissive:
                ...
                float node_5095 = saturate((_Surface_var.r*_Shine_texture_var.r));
                ...
                return fixed4(finalColor,saturate((1.0-(1.0-node_5095)*(1.0-saturate(( _CrystalClearness > 0.5 ? (1.0-(1.0-2.0*(_CrystalClearness-0.5))*(1.0-(1.0-(1.0-_Shine_texture_var.r)*(1.0-saturate(( _Surface_var.r > 0.5 ? (1.0-(1.0-2.0*(_Surface_var.r-0.5))*(1.0-node_4316)) : (2.0*_Surface_var.r*node_4316) )))))) : (2.0*_CrystalClearness*(1.0-(1.0-_Shine_texture_var.r)*(1.0-saturate(( _Surface_var.r > 0.5 ? (1.0-(1.0-2.0*(_Surface_var.r-0.5))*(1.0-node_4316)) : (2.0*_Surface_var.r*node_4316) ))))) ))))));
            }
            ENDCG
        }
    }
